...
# Required Data
data("iris")
head(iris) # target variable is Species
...
#  3 ---- using library rpart and rpart.plot
...
#From the random forest we could say that we got accuracy ranging from 91% to 97%
