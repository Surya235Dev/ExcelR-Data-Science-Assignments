# Extracting reviews for Canon DLSR Digital Camera from  Amazon 
#URL for camera Canon DSLR is
#https://www.amazon.in/Canon-1500D-Digital-Camera-S18-55/product-reviews/B07BS4TJ43/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber=1
...
# copy url of product in URL variable
url <- "https://www.amazon.in/Canon-1500D-Digital-Camera-S18-55/product-reviews/B07BS4TJ43/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber"
amazon_reviews <- NULL
for (i in 1:10){
...
#Write review in the CanonDSLR1500D.txt file
write.table(amazon_reviews,"CanonDSLR1500D.txt",row.names = F)

#Read reviews from CanonDSLR1500D.txt file
SM30 <- unique(readLines("CanonDSLR1500D.txt"))
